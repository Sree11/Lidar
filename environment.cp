...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  //renderRays(viewer, lidar->position, inputCloud);
   ...
   //std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr, pcl::PointCloud<pcl::PointXYZ>::Ptr> segmentCloud = pointProcessor->SegmentPlane(inputCloud, 100, 0.2);
    ...
    renderPointCloud(viewer, segmentCloud.first,"Obst Cloud", Color(1,0,0) );
    ...
    renderPointCloud(viewer, segmentCloud.second, "second cloud");
...
//void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.euclideanCluster(segmentCloud.first, tree, 0.53, 10, 500);
  ...
  //filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.3 , Eigen::Vector4f (-10, 15, -2, 1), Eigen::Vector4f ( 30, 8, 1, 1));
...
int main (int argc, char** argv)
{
    ...
    while (!viewer->wasStopped ())
    {
        ...
        cout<<"THe file is "<<inputCloudI<<std::endl;
